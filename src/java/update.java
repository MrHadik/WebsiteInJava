...
public class update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            String nc = request.getParameter("txtcemail");
            ...
            try{
                ...
                stmt.executeUpdate("UPDATE `Project` SET `email`='"+nm+"',`pass`='"+npss+"',`name`='"+nn+"',`sarname`='"+ns+"' WHERE email='"+nc+"'");
